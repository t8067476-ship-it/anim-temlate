...
function useScrollAnimations() {
  useEffect(() => {
    const scaleEls = Array.from(document.querySelectorAll<HTMLElement>(".mil-scale"));
    ...
    const ups = Array.from(document.querySelectorAll<HTMLElement>(".mil-up"));
    const io = new IntersectionObserver(
      (entries) => {
        for (const entry of entries) {
          if (entry.isIntersecting) entry.target.classList.add("mil-inview");
          else entry.target.classList.remove("mil-inview");
        }
      },
      { threshold: 0.15 }
    );
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Banner */}
      <section className="mil-banner mil-dark-bg relative">
        <div className="mi-invert-fix">
          <div className="mil-animation-frame">
            ...
            <div className="mil-animation mil-position-3 mil-scale" data-value-1="1.2" data-value-2="0.1">
              <Dodecahedron />
            </div>
          </div>
      ...
      {/* About */}
      <section id="about">
        <div className="max-w-screen-xl mx-auto px-4 mil-p-120-30">
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8">
            <div className="lg:col-span-6 xl:col-span-5"></div>
            <div className="lg:col-span-5 lg:col-start-8">
              <div className="mil-about-photo mil-mb-90 relative">
                ...
                <div className="mil-up mil-img-frame pb-[160%]"></div>
              </div>
            </div>
          </div>
        </div>
